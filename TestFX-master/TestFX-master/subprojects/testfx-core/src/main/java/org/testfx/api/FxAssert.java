...
public final class FxAssert {
     ...
     * @param value the value to assert and verify 
     * @param matcher the matcherAssert
     * @param errorMessageMapper error function to trigger when the degug does not work properly 
     */
    private static <T> void verifyThatImpl(String reason, T value, Matcher<? super T> matcher,
        ...
        try {
            ...
            // make assertion throw more reliable.
