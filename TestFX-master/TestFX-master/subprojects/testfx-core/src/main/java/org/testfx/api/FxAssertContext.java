...
public class FxAssertContext {
    ...
    /**
     * the getter of this node finder
     * @return return this node finder
     */
    ...
    /**
     * this node's setter 
     * @param nodeFinder the node to remplace this node 
     */
    public void setNodeFinder(NodeFinder nodeFinder) {
        this.nodeFinder = nodeFinder;
    }
    /**
     * the getter of this capture support
     * @return return this captureSuppot 
     */
    public CaptureSupport getCaptureSupport() {
        return captureSupport;
    }
    /**
     * this captureSupport's setter 
     * @param captureSupport the capture to remplace this captureSupport 
     */
